...
class Log {
    ...
    public function logMessage($fileName, $message){
        ...
        //Get the day number
        $dayNumber = floor(time()/86400);

        //Determine file name
        $fileName = DATA_PATH.$this->parent->config->get("logFolder").$dayNumber;
    ...
    public function clean(){
        ...
        $logFolderName = DATA_PATH.$this->parent->config->get("logFolder");
        $dayNumberExpire = floor(time()/86400)-$this->parent->config->get("keepLogs");
